  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved folder as @folder" do
        ...
        post :create, {:folder => { "name" => "invalid value" }}, valid_session
        assigns(:folder).should be_a_new(Folder)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested folder" do
        ...
        Folder.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => folder.to_param, :folder => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the folder as @folder" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Folder.any_instance.stub(:save).and_return(false)
        put :update, {:id => folder.to_param, :folder => { "name" => "invalid value" }}, valid_session
        assigns(:folder).should eq(folder)
      end
