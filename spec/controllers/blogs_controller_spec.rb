...
describe BlogsController do
  ...
  let(:valid_attributes) { { "titile" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved blog as @blog" do
        ...
        post :create, {:blog => { "titile" => "invalid value" }}, valid_session
        assigns(:blog).should be_a_new(Blog)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested blog" do
        ...
        Blog.any_instance.should_receive(:update_attributes).with({ "titile" => "MyString" })
        put :update, {:id => blog.to_param, :blog => { "titile" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the blog as @blog" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Blog.any_instance.stub(:save).and_return(false)
        put :update, {:id => blog.to_param, :blog => { "titile" => "invalid value" }}, valid_session
        assigns(:blog).should eq(blog)
      end
