  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "redirects to the created site_config" do
        post :create, {:site_config => valid_attributes}, valid_session
        response.should redirect_to(SiteConfig.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved site_config as @site_config" do
        ...
        post :create, {:site_config => { "domain" => "invalid value" }}, valid_session
        assigns(:site_config).should be_a_new(SiteConfig)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested site_config" do
        site_config = SiteConfig.create! valid_attributes
        # Assuming there are no other site_configs in the database, this
        # specifies that the SiteConfig created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        SiteConfig.any_instance.should_receive(:update_attributes).with({ "domain" => "MyString" })
        put :update, {:id => site_config.to_param, :site_config => { "domain" => "MyString" }}, valid_session
      end
      ...
      it "redirects to the site_config" do
        site_config = SiteConfig.create! valid_attributes
        put :update, {:id => site_config.to_param, :site_config => valid_attributes}, valid_session
        response.should redirect_to(site_config)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the site_config as @site_config" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        SiteConfig.any_instance.stub(:save).and_return(false)
        put :update, {:id => site_config.to_param, :site_config => { "domain" => "invalid value" }}, valid_session
        assigns(:site_config).should eq(site_config)
      end
